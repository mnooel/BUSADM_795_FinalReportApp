...
server <- function(input, output, session) {
  ...
  output$im_plot9 <- renderImage({
    ...
    render_neural_network <- function(layer1, layer2, layer3, percent_test) {
      ...
      # test percentage
      test_percentage <- (percent_test / 100)
    ...
    render_neural_network(input$im_plot9_slider1,
